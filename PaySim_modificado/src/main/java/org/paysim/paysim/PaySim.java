...
public class PaySim extends SimState {
    ...
    private static final String[] DEFAULT_ARGS = new String[]{"", "-file", "PaySim.properties", "100"};
    ...
    public static void main(String[] args) {
        ...
        int nbTimesRepeat = Parameters.nbIterations;
    ...
    private void runSimulation(int count) {
        System.out.println();
    ...
    public void copyRawLog(int count) {
        Output.createDirIfNeeded();
        Output.copyRawLog(count);
    }
